...
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:luigi.gonnella@studenti.polito.it)
...
```yaml
name: Luigi Gonnella
located_in: Turin, Italy
current_role: Software Engineering MsC Student
education: ["Computer Engineering", "Politecnico di Torino"]
interests: ["Open Source", "AI/ML", "Software Development"]
```
...
### Cloud & AI Infrastructure (currently learning)
...
![Weights & Biases](https://img.shields.io/badge/Weights_&_Biases-FF3F6C?style=for-the-badge&logo=wandb&logoColor=white)
...
<a href="https://github.com/LuigiGonnella/GAN-for-Data-Augmentation-and-Domain-Adaptation">
  <img src="https://github.com/LuigiGonnella/GAN-for-Data-Augmentation-and-Domain-Adaptation/raw/main/preview.jpg" width="300px" alt="GAN Project" />
</a>

<a href="https://github.com/LuigiGonnella/Architectures-For-Code-Development-With-LLMs">
  <img src="https://github.com/LuigiGonnella/Architectures-For-Code-Development-With-LLMs/raw/main/preview.jpg" width="300px" alt="LLM Architectures Project" />
</a>
...
```javascript
const luigi = {
    currentFocus: "Developing large language models and AI-powered applications",
    learning: ["Reinforcement Learning", "Diffusion Models", "Advanced Transformers"],
    collaborating: "Open to collaborating on cutting-edge AI and open-source ML projects",
    goals2026: [
        "Contribute to top AI/ML open-source libraries",
        "Publish AI research or blog posts",
        "Deploy scalable ML systems in production",
        "Experiment with multi-modal AI applications"
    ],
    hobbies: ["Reading AI research papers", "Experimenting with ML models", "Chess & strategy games", "Tech photography"]
};
...
### 💡 "Don't get too comfortable." – Future

---

![Profile Views](https://komarev.com/ghpvc/?username=LuigiGonnella&color=blueviolet&style=for-the-badge)

**⭐ From [LuigiGonnella](https://github.com/LuigiGonnella)**
